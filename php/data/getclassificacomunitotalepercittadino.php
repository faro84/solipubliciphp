<?php
    ...
    $limit = $end;
    $sql = "SELECT descr_comune, totalepercittadino, anagrafe_comuni.cod_comune,anagrafe_comuni.cod_provincia  FROM soldipubblici_notebook.comuni_spesatotale 
            ...
            order by comuni_spesatotale.totalepercittadino desc limit 10;";
    //echo $sql;
    ...
    if ($result->num_rows > 0) {
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "<span class=\"badge\">" . $row["totalepercittadino"] . "</span>";
